...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8903613844588092028L;
  ...
  private org.ordering.kafka.order.avro.model.PaymentOrderStatus paymentOrderStatus;
   ...
   */
  public PaymentRequestAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID customerId, java.util.UUID orderId, java.math.BigDecimal price, java.time.Instant createdAt, org.ordering.kafka.order.avro.model.PaymentOrderStatus paymentOrderStatus) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: paymentOrderStatus = (org.ordering.kafka.order.avro.model.PaymentOrderStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public org.ordering.kafka.order.avro.model.PaymentOrderStatus getPaymentOrderStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentOrderStatus(org.ordering.kafka.order.avro.model.PaymentOrderStatus value) {
   ...
   */
  public static org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder newBuilder() {
    return new org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder();
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder newBuilder(org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder other) {
    if (other == null) {
      return new org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder();
    } else {
      return new org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder newBuilder(org.ordering.kafka.order.avro.model.PaymentRequestAvroModel other) {
    if (other == null) {
      return new org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder();
    } else {
      return new org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.ordering.kafka.order.avro.model.PaymentRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder setCustomerId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder setPaymentOrderStatus(org.ordering.kafka.order.avro.model.PaymentOrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearPaymentOrderStatus() {
    ...
    public PaymentRequestAvroModel build() {
      try {
        ...
        record.paymentOrderStatus = fieldSetFlags()[6] ? this.paymentOrderStatus : (org.ordering.kafka.order.avro.model.PaymentOrderStatus) defaultValue(fields()[6]);
        return record;
