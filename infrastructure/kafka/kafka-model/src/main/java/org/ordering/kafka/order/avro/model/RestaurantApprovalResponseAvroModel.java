...
public class RestaurantApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5459268966155713247L;
  ...
  private org.ordering.kafka.order.avro.model.OrderApprovalStatus orderApprovalStatus;
   ...
   */
  public RestaurantApprovalResponseAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID restaurantId, java.util.UUID orderId, java.time.Instant createdAt, org.ordering.kafka.order.avro.model.OrderApprovalStatus orderApprovalStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: orderApprovalStatus = (org.ordering.kafka.order.avro.model.OrderApprovalStatus)value$; break;
   ...
   */
  public org.ordering.kafka.order.avro.model.OrderApprovalStatus getOrderApprovalStatus() {
   ...
   * @param value the value to set.
   */
  public void setOrderApprovalStatus(org.ordering.kafka.order.avro.model.OrderApprovalStatus value) {
   ...
   */
  public static org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder newBuilder() {
    return new org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder();
  }
   ...
   * @return A new RestaurantApprovalResponseAvroModel RecordBuilder
   */
  public static org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder newBuilder(org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder other) {
    if (other == null) {
      return new org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder();
    } else {
      return new org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new RestaurantApprovalResponseAvroModel RecordBuilder
   */
  public static org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder newBuilder(org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel other) {
    if (other == null) {
      return new org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder();
    } else {
      return new org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setRestaurantId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearRestaurantId() {
      restaurantId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setOrderApprovalStatus(org.ordering.kafka.order.avro.model.OrderApprovalStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearOrderApprovalStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setFailureMessages(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearFailureMessages() {
    ...
    public RestaurantApprovalResponseAvroModel build() {
      try {
        ...
        record.orderApprovalStatus = fieldSetFlags()[5] ? this.orderApprovalStatus : (org.ordering.kafka.order.avro.model.OrderApprovalStatus) defaultValue(fields()[5]);
