...
public class CustomerAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4527359156401277673L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CustomerAvroModel\",\"namespace\":\"org.ordering.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"username\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder newBuilder() {
    return new org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder();
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder newBuilder(org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder other) {
    if (other == null) {
      return new org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder();
    } else {
      return new org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder(other);
    }
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder newBuilder(org.ordering.kafka.order.avro.model.CustomerAvroModel other) {
    if (other == null) {
      return new org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder();
    } else {
      return new org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.ordering.kafka.order.avro.model.CustomerAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder setUsername(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ordering.kafka.order.avro.model.CustomerAvroModel.Builder clearLastName() {
      lastName = null;
