insert into "ordering".orders(id, customer_id, restaurant_id, tracking_id, price, order_status, failure_messages)
...
insert into "ordering".order_items(id, order_id, product_id, price, quantity, sub_total)
values(1, 'd215b5f8-0249-4dc5-89a3-51fd148cfb17', 'd215b5f8-0249-4dc5-89a3-51fd148cfb47', 100.00, 1, 100.00);

insert into "ordering".order_address(id, order_id, street, postal_code, city)
values('d215b5f8-0249-4dc5-89a3-51fd148cfb15', 'd215b5f8-0249-4dc5-89a3-51fd148cfb17', 'test street', '1000AA', 'test city');

insert into "ordering".payment_outbox(id, saga_id, created_at,  outbox_status, saga_status, order_status,type, payload, version)
values ('8904808e-286f-449b-9b56-b63ba8351cf2', '15a497c1-0f4b-4eff-b9f4-c402c8c07afa', current_timestamp,'STARTED', 'STARTED', 'PENDING', 'OrderProcessingSaga',
