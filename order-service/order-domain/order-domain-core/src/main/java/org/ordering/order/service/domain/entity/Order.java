package org.ordering.order.service.domain.entity;
...
public  class Order extends AggregateRoot<OrderId> {
    ...
    public void validateOrder() {
        //validate if order status is a new order
        validateInitialOrder();
        //validate if total price of order > 0
        validateTotalPrice();
        //validate total price equals to sum of item price
        validateItemsPrice();
    }
